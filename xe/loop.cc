...
int xe_loop::read_ex(xe_req& req, byte sq_flags, ushort ioprio, ushort buf_group, int fd, xe_ptr buf, uint len, long offset, uint flags){
...
int xe_loop::readv_ex(xe_req& req, byte sq_flags, ushort ioprio, ushort buf_group, int fd, const iovec* vecs, uint vlen, long offset, uint flags){
...
int xe_loop::recv_ex(xe_req& req, byte sq_flags, ushort ioprio, ushort buf_group, int fd, xe_ptr buf, uint len, uint flags){
...
int xe_loop::recvmsg_ex(xe_req& req, byte sq_flags, ushort ioprio, ushort buf_group, int fd, msghdr* msg, uint flags){
...
#define XE_OP_ALIAS3(func, ...) int xe_loop::func(xe_req& req, ##__VA_ARGS__)
#define XE_OP_ALIAS3_BODY(func, ...) {				\
	return func##_ex(req, 0, 0, 0, ##__VA_ARGS__);	\
}

#define XE_OP_ALIAS3_PROMISE_EX(func, ...) xe_promise xe_loop::func##_ex(byte sq_flags, ushort ioprio, ushort buf_group, ##__VA_ARGS__)
#define XE_OP_ALIAS3_PROMISE_BODY_EX(func, ...) {		\
	return make_promise(0, [&](xe_promise& promise){	\
		return func##_ex(promise, sq_flags, ioprio, buf_group, ##__VA_ARGS__);	\
	});													\
}

#define XE_OP_ALIAS3_PROMISE(func, ...) xe_promise xe_loop::func(__VA_ARGS__)
#define XE_OP_ALIAS3_PROMISE_BODY(func, ...) {	\
	return func##_ex(0, 0, 0, ##__VA_ARGS__);	\
}
...
XE_OP_ALIAS3(read, READ_ARGS) XE_OP_ALIAS3_BODY(read, READ_VARS)
XE_OP_ALIAS3_PROMISE_EX(read, READ_ARGS) XE_OP_ALIAS3_PROMISE_BODY_EX(read, READ_VARS)
XE_OP_ALIAS3_PROMISE(read, READ_ARGS) XE_OP_ALIAS3_PROMISE_BODY(read, READ_VARS)
...
XE_OP_ALIAS3(readv, READV_ARGS) XE_OP_ALIAS3_BODY(readv, READV_VARS)
XE_OP_ALIAS3_PROMISE_EX(readv, READV_ARGS) XE_OP_ALIAS3_PROMISE_BODY_EX(readv, READV_VARS)
XE_OP_ALIAS3_PROMISE(readv, READV_ARGS) XE_OP_ALIAS3_PROMISE_BODY(readv, READV_VARS)
...
XE_OP_ALIAS3(recv, RECV_ARGS) XE_OP_ALIAS3_BODY(recv, RECV_VARS)
XE_OP_ALIAS3_PROMISE_EX(recv, RECV_ARGS) XE_OP_ALIAS3_PROMISE_BODY_EX(recv, RECV_VARS)
XE_OP_ALIAS3_PROMISE(recv, RECV_ARGS) XE_OP_ALIAS3_PROMISE_BODY(recv, RECV_VARS)
...
XE_OP_ALIAS3(recvmsg, RECVMSG_ARGS) XE_OP_ALIAS3_BODY(recvmsg, RECVMSG_VARS)
XE_OP_ALIAS3_PROMISE_EX(recvmsg, RECVMSG_ARGS) XE_OP_ALIAS3_PROMISE_BODY_EX(recvmsg, RECVMSG_VARS)
XE_OP_ALIAS3_PROMISE(recvmsg, RECVMSG_ARGS) XE_OP_ALIAS3_PROMISE_BODY(recvmsg, RECVMSG_VARS)
